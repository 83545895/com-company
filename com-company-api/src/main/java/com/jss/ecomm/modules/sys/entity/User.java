...
public class User extends DataEntity<User> {
	...
	private List<Position> positionList = Lists.newArrayList(); // 拥有职务列表
	/*private String phoneExtension;	//分机号
	private String groupCornet;	//集团短号
	private Integer sort;	//排序
*/	private Position position;	//职务
	
	private String officeName;	//查询
	...
	public void setGroupCornet(String groupCornet) {
